...
& & \qquad + \langle B, A - L - S - E\rangle +  \frac{\rho}{2} \| A - L -  S - E\|_F^2 
\end{eqnarray} 
...
some unknown $x_i\in \R^k$. Then the primal problem is feasible with $Z= (I_d; Y)^T (I_d; Y)$. Therefore the complementary condition holds and the duality gap is zero. In this case, assume that $Z^*$ is a primal feasible solution of SDP embedding and $S^*$ is an optimal dual solution,
then 
\begin{enumerate}
