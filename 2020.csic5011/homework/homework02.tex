...
\lecture{Homework 2. Random Matrix Theory and PCA}{Yuan Yao}{Due: 1.5 weeks}{Feb 26, 2020}
...
which contains the data matrix $X\in \R^{n\times p}$ of $n=1258$ consecutive observation days and $p=452$ daily closing stock prices, and the cell variable ``${\rm stock}$" collects the names, codes, and the affiliated industrial sectors of the 452 stocks. Use Matlab, Python, or R for the following exploration. 
\begin{enumerate}
