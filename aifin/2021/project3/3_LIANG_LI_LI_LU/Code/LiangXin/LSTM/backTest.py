...
format1_dir = os.getcwd() + '/data/backtest_data_format1_week_final.h5'
format2_dir = os.getcwd() + '/data/backtest_data_format2_week_final.h5'
...
from LiangXin.LSTM.strategy import handle_bar
