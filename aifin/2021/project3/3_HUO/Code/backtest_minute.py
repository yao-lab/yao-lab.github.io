...
format1_dir = './eval_data_format1_week_final.h5'
format2_dir = './eval_data_format2_week_final.h5'
...
from strategy_minute import handle_bar
...
if __name__ == '__main__':
    ...
    strategyDetail.to_csv(working_folder+"/backtest2_details.csv")  # output backtest details to your working folder
