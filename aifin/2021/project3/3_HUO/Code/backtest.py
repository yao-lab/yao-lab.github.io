...
format1_dir = './backtest_data_format1_final.h5'
format2_dir = './backtest_data_format2_final.h5'
...
class backTest:
    ...
    def pnl_analyze(self, strategyDetail):
        ...
        balance_daily.plot(figsize=(12, 3), title='Balance Curve', grid=True)
    ...
    def backTest(self):
        ...
        for i in range(len(keys)):
            ...
            if i == 0:
                ...
                position_old = np.repeat(0., 1)
                position_new = np.repeat(0., 1)
                details = list()
                stop_signal = False
...
if __name__ == '__main__':
    ...
    bt.pnl_analyze(strategyDetail)  # print performance summary, plcleaot balance curve