# HodgeRank for kaggle chess player rating

# system.time(source("chessHodge.r", echo=TRUE))
# scoring by hodge
...
train <- as.matrix(read.csv("./training_data.csv"))
valid <- as.matrix(read.csv("./cross_validation_dataset.csv"))
test <- as.matrix(read.csv("./test_scores.csv"))
