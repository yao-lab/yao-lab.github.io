...
# 
# Used for Yuan Yao's course project in Peking University, 2012
#
# Reference: 
#	How I won the "Chess Ratings -- Elo vs the Rest of the World" Competition
#	Yannis Syismanis, arXiv:1012.4571v1
#
# The code is not optimized, which takes about 10 mins and returns the mean square root error 
# 0.68896
