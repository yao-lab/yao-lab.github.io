...
def model(features, test_features, encoding='ohe', n_folds=5):
    ...
    for train_indices, valid_indices in k_fold.split(features):
        ...
        #    min_samples_split=10, random_state=50, verbose=1)
...
#submission.to_csv('submission_manualp3_multicsv_random_forest.csv', index = False)
submission.to_csv('submission_manualp3_multicsv_extra_tree2.csv', index = False)
