...
%Q1(c)
[rho_google_pr, ~]=corr(idp,v,'type','Kendall'); %Google Pagerank kendall tau distance

[rho_HITS_hub_pr, ~]=corr(idu,v,'type','Kendall'); %HITS hub Pagerank

[rho_HITS_authority_pr, ~]=corr(idv,v,'type','Kendall'); %HITS authority Pagerank
