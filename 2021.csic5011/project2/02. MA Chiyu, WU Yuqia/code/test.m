...
% spearman
spearman_corr_aut = corr(idv,rank_cn,'Type','Spearman'); % authority
spearman_corr_hub = corr(idu,rank_cn,'Type','Spearman'); % hub

% Kendall
kendall_corr_aut = corr(idv,rank_cn,'Type','Kendall'); % authority
kendall_corr_hub = corr(idu,rank_cn,'Type','Kendall'); % hub