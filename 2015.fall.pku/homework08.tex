...
\lecture{Homework 9. Neural Networks}{Yuan Yao}{}{Deadline: November 30, 2015}
...
\begin{enumerate}
\item (ESL) Exercise 17.1

\item (ESL) Exercise 17.2

\item (ESL) Exercise 17.6

\item (ESL) Exercise 17.7

\item[A*] (Bonus: you don't need to work on this problem, but bonus scores will be given if you tried.) (ESL) Exercise 17.3
