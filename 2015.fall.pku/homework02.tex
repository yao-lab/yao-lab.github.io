...
\lecture{Homework 2. Linear Regression}{Yuan Yao}{}{Deadline: October 12, 2015}
...
\begin{enumerate}
\item (ESL) Exercise 3.1

\item (ESL) Exercise 3.3

\item (ESL) Exercise 3.5

\item (ESL) Exercise 3.7

\item (ESL) Exercise 3.12

\item (ESL) Exercise 3.20

\item (ESL) Exercise 3.23

\item (ESL) Exercise 3.27
