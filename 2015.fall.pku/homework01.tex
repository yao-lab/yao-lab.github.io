...
\lecture{Homework 1. Overview of Supervised Learning}{Yuan Yao}{}{Deadline: September 28, 2015}
...
\begin{enumerate}
\item (ESL) Exercise 2.5

\item (ESL) Exercise 2.7

\item (ESL) Exercise 2.8

\item (ESL) Exercise 2.9
